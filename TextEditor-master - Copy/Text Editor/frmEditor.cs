...
namespace Text_Editor
{
    public partial class frmEditor : Form
    {
        ...
        class Program
        {
            static void Main()
            {
                // Specify the path to the Visual Studio executable
                string visualStudioPath = @"C:\Program Files\Microsoft Visual Studio\2022\Community\Common7\IDE\devenv.exe";

                // Specify the path to the solution file (.sln) you want to open
                string solutionPath = @"C:\Users\PC\Desktop\TextEditor-master - Copy\Text Editor.sln";

                // Start Visual Studio and open the solution
                Process.Start(visualStudioPath, solutionPath);

                Console.WriteLine("Solution opened successfully.");
                Console.ReadLine();
            }
        }
